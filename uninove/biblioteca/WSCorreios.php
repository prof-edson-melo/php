...
/**
 * @category Implementação de Webservice dos Correios
 * 
 */
class WSCorreios {
    ...
    /**
     * Informa se a encomenda deve ser entregue com a opç?o "M?o Própria"
     *
     * @param boolean $flag true = sim | false = n?o
     *
     * @return RsCorreios
     */
    ...
    /**
     * Obtém a informaç?o se a encomenda deve ser entregue
     * com a opç?o "M?o Própria"
     * true = sim; false = n?o
     *
     * @return boolean
     */
    ...
    /**
     * Obtém a informaç?o se a encomenda deve ser entregue
     * com a opç?o "Aviso de Recebimento"
     * S = sim; N = n?o
     *
     * @return boolean
     */
     ...
     * Lança uma exceç?o caso um valor diferente seja passado como parâmetro
     *
     ...
     * (somente as opç?es sem contrato):
